...
class PublicRecipeAPITests(TestCase):
    ...
    def setUp(self):
        """Config API client for all public tests."""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        """Config API Client and authentication for all private tests."""
        self.client = APIClient()
    ...
    def test_update_user_returns_error(self):
        """Test if updating the user returns error."""
    ...
    def test_create_tag_on_update(self):
        """Test creating a new tag when update."""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_ingredient_on_update(self):
        """Test creating a new ingredient when update."""
        recipe = create_recipe(user=self.user)
    ...
    def test_clear_recipe_ingredients_on_update(self):
        """Test clearing a recipe ingredients when updating."""
...
class ImageUploadTests(TestCase):
    ...
    def setUp(self):
        """Create a client, user,and recipe before each tests."""
        self.client = APIClient()
    ...
    def tearDown(self):
        """Delete recipe image after each test."""
